...
r_proj, v_los = per_emb_50_get_vc_r('../'+H2CO_303_202_fit_Vc+'.fits', '../'+region_streamer2)
...
# pickle_in = open('streamer_model0_params.pickle', "rb")
# theta0, r0, phi0, v_r0, omega0, v_lsr = pickle.load(pickle_in)
...
plt.show()
if savemodel:
    fig.savefig('streamline_vlsr_r_kde_peremb50_H2CO_model1.pdf')
...
fig2.show_regions('../'+region_streamer2)
...
plt.show()
if savemodel:
    fig2.savefig('streamline_plane_peremb50_H2CO_model1.pdf')
...
if savemodel:
    stream_params = 'streamer_model1_params.pickle'
    ...
    stream_pickle = 'streamer_model1.pickle'
