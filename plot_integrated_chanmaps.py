...
cubename = folder + 'Per-emb-50_CD_l027l066_uvsub_13CO_multi'
nrows = 3
ncols = 5
velinit = 7
velend = 13
stretch = 'linear'
scalebarsize = 2000 # au
plotname = cubename + '_integratedchanmaps_'+str(velinit)+'to'+str(velend)+'_'+str(ncols*nrows)+'cells_'+stretch+'.png'
deltav = (velend-velinit)/(nrows*ncols)
radiusplot = 17/3600
# logscale = False
cmap = 'inferno'
coloraxisname = 'Jy/beam km/s'
vmin = -0.02
vmax = 0.08
textsizept = 12
figsize = (9,8)
